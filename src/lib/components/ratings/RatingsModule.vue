...
function adjustRating(this: HTMLDivElement, e: MouseEvent) {
  // console.log(
  //   this.offsetLeft,
  //   "number of pixels that the upper left corner of the current element"
  // );
  // console.log(e.pageX, "CURRENT MOUSE ON X ");
  const relativeX = e.pageX - this.offsetWidth - this.offsetLeft + 32;
